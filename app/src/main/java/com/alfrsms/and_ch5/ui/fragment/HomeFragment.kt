...
import com.alfrsms.and_ch5.databinding.FragmentHomeBinding
import com.alfrsms.and_ch5.model.Data
import com.alfrsms.and_ch5.model.MovieResponse
import com.alfrsms.and_ch5.service.TmdbApiService
import com.alfrsms.and_ch5.ui.adapter.HomeAdapter
...
class HomeFragment : Fragment() {
    ...
    private fun getMovieData(callback: (List<Data>) -> Unit){
        TmdbApiService.instance.getPopularMovies().enqueue(object : Callback<MovieResponse> {
